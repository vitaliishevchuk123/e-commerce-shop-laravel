<div>
    ...
    <form wire:submit.prevent="searchCategory" class="mb-4 flex align-center gap-2">
        <input type="text" wire:model.defer="search"
               ...
               class="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-white rounded-lg px-4 py-1 focus:outline-none focus:border-blue-500 transition duration-300"
        />
